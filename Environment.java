...
/**
 * Environment is the world where the simulation takes place.
 * It contains the road network and the cars.
 *
 * @author EloiMusk
 */
public class Environment extends World {
    ...
    /**
     * The road network is a graph of WayPoints and Edges.
     */
    public Graph roadNetwork = new Graph();

    /**
     * Represents if the environment has been initialized.
     */
    private boolean initialized = false;

    /**
     * Represents the number of loops the simulation has been running, since the last car spawn.
     */
     ...
     * The environment is a 600x600 world with a 1x1 cell size.
     * The background is set to a default image.
     */
    public Environment() {
    ...
    /**
     * Spawns a car at a random incoming edge node.
     */
...
//        Car[] cars = getObjects(Car.class).toArray(Car[]::new);
    ...
    /**
     * Generates the graph, that represents the road network.
     * The graph is generated by drawing a line from the bottom of the screen to the top.
     * Every time the line reaches a certain height, a new line is drawn from the left side of the screen to the right.
     */
...
//                        Straight
    ...
    /**
     * Connects all way points with each other.
     */
